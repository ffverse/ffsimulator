#' Optimise Lineups
#'
#' Optimises lineups for all franchises in the dataframe based on a table of lineup constraints
#'
...
#'
#' Optimises lineups for one franchise week at a time. Use purrr or loop to do more franchises/weeks/seasons
#'
